...
M2-Movies-2024/gui_handlers

/handlers.py
This started life as a simple copy of M2-Movies-2024/handlers.py.
Functions will be removed after refactoring into guidatabase.py leaving
behind the functions which do not call database_src/tables.py
