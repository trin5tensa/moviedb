...
class TestMovieGUI:
    ...
    def test_tmdb_search(self, check):
        ...
        cut = guiwidgets_2.MovieGUI(DummyTk(), lambda: None, self.tags, add_movie_callback=lambda: None)
    ...
    def test_commit_a_movie(self, check):
        ...
        callback = MagicMock()
        cut = guiwidgets_2.MovieGUI(DummyTk(), lambda: None, self.tags, add_movie_callback=callback)
