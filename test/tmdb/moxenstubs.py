...
TEST_SYNOPSIS: Final = "It was a good test wot I wrote."
...
TEST_MOVIE_NOT_FOUND_LOG_MSG: Final = (
    f"The TMDB id '42' was not found on the TMDB site. \n"
...
class DummyTMDBTimeoutError(DummyTMDBSearch):
    def movie(self, **kwargs):
        raise tmdb.requests.exceptions.ConnectionError(
            DummyExcArgs(TEST_TIMEOUT_EXC_ARGS)
        )
...
class DummyTMDBMovies:
    ...
    def __post_init__(self):
        """A failure of this assertion indicates that the movie_id 'found' by
        DummyTMDBSearch.movie has not been correctly used in the call to
        DummyTMDBMovies.
        """
